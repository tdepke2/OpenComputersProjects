...
function mnet.registerDevice(address, proxy)
  xassert(proxy == nil or (proxy.open and proxy.close and proxy.send and proxy.broadcast), "provided proxy for device must implement open(), close(), send(), and broadcast().")
...
mnet.mtuAdjusted = (mnet.mtuAdjusted or 8192) - 150
